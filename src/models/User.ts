...
export interface UserInstance
  extends Model<User, UserCreationAttributes>, User {
    // Adicionando à cada instância de User o método criado utilizando o .prototype:
...
// Criando um método para todas as instâncias de User, para isso, utilizamos o .prototype:
